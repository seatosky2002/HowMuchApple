...
async def get_summary(
    ...
    data = await analytics_service.get_summary(db, sku_id, region_id)
...
async def get_listings(
    ...
    data = await analytics_service.get_listings(db, sku_id, region_id, page, page_size, sort, source)
...
async def get_platform_compare(
    ...
    platforms = await analytics_service.get_platform_compare(db, sku_id, region_id)
